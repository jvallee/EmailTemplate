...
let AppModule = class AppModule {
    constructor(program, versionManager, passTroughService) {
        this.program = program;
        this.versionManager = versionManager;
        this.passTroughService = passTroughService;
        this.onApplicationBootstrap = () => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.passTroughService.init();
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_nestjs_common__WEBPACK_IMPORTED_MODULE_1__["Module"])({
        ...
        providers: [
            ...
            _services__WEBPACK_IMPORTED_MODULE_6__["PassTroughService"],
...
/*!******************************************************!*\
  !*** ./apps/generator-cli/src/app/services/index.ts ***!
  \******************************************************/
/*! exports provided: UIService, ConfigService, GeneratorService, PassTroughService, VersionManagerService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _pass_trough_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pass-trough.service */ "./apps/generator-cli/src/app/services/pass-trough.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PassTroughService", function() { return _pass_trough_service__WEBPACK_IMPORTED_MODULE_3__["PassTroughService"]; });
...
/*!********************************************************************!*\
  !*** ./apps/generator-cli/src/app/services/pass-trough.service.ts ***!
  \********************************************************************/
/*! exports provided: PassTroughService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PassTroughService", function() { return PassTroughService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "tslib");
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(tslib__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _nestjs_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
/* harmony import */ var _nestjs_common__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_nestjs_common__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _version_manager_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./version-manager.service */ "./apps/generator-cli/src/app/services/version-manager.service.ts");
...
/* harmony import */ var _generator_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./generator.service */ "./apps/generator-cli/src/app/services/generator.service.ts");
var _a, _b, _c, _d;
...
let PassTroughService = class PassTroughService {
    constructor(logger, program, versionManager, generatorService) {
        this.logger = logger;
        this.program = program;
        this.versionManager = versionManager;
        this.generatorService = generatorService;
        this.passTrough = (args = []) => Object(child_process__WEBPACK_IMPORTED_MODULE_7__["spawn"])(this.cmd(), args, {
            stdio: 'inherit',
            shell: true
        ...
        this.getCommands = () => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const commands = help.split('\n')
                .filter(line => Object(lodash__WEBPACK_IMPORTED_MODULE_4__["startsWith"])(line, ' '))
                .map(lodash__WEBPACK_IMPORTED_MODULE_4__["trim"])
        ...
        this.run = (subCmd) => new Promise((resolve, reject) => {
            Object(child_process__WEBPACK_IMPORTED_MODULE_7__["exec"])(`${this.cmd()} ${subCmd}`, (error, stdout, stderr) => {
    ...
    init() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            (yield this.getCommands()).forEach(([command, desc]) => {
                this.program
                    .command(command, { hidden: !desc })
                    .allowUnknownOption()
                    .description(desc)
                    .action((cmd) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                        ...
                        switch (cmd.name()) {
                            ...
                            case 'generate':
                                if (this.generatorService.enabled) {
                                    if (!(yield this.generatorService.generate())) {
                                        this.logger.log(chalk__WEBPACK_IMPORTED_MODULE_5__["red"]('Code generation failed'));
                                        process.exit(1);
                                    }
                                    return;
                                }
    ...
    cmd() {
        return ['java', process.env['JAVA_OPTS'], `-jar "${this.versionManager.filePath()}"`].filter(lodash__WEBPACK_IMPORTED_MODULE_4__["isString"]).join(' ');
    }
};
PassTroughService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_nestjs_common__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(0, Object(_nestjs_common__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_constants__WEBPACK_IMPORTED_MODULE_2__["LOGGER"])),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(1, Object(_nestjs_common__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_constants__WEBPACK_IMPORTED_MODULE_2__["COMMANDER_PROGRAM"])),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [typeof (_a = typeof _constants__WEBPACK_IMPORTED_MODULE_2__["LOGGER"] !== "undefined" && _constants__WEBPACK_IMPORTED_MODULE_2__["LOGGER"]) === "function" ? _a : Object, typeof (_b = typeof commander__WEBPACK_IMPORTED_MODULE_3__["Command"] !== "undefined" && commander__WEBPACK_IMPORTED_MODULE_3__["Command"]) === "function" ? _b : Object, typeof (_c = typeof _version_manager_service__WEBPACK_IMPORTED_MODULE_6__["VersionManagerService"] !== "undefined" && _version_manager_service__WEBPACK_IMPORTED_MODULE_6__["VersionManagerService"]) === "function" ? _c : Object, typeof (_d = typeof _generator_service__WEBPACK_IMPORTED_MODULE_8__["GeneratorService"] !== "undefined" && _generator_service__WEBPACK_IMPORTED_MODULE_8__["GeneratorService"]) === "function" ? _d : Object])
], PassTroughService);
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                yield this.httpService
                    ...
                    const file = fs_extra__WEBPACK_IMPORTED_MODULE_4__["createWriteStream"](filePath);
                    res.data.pipe(file);
